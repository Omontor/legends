                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.partner-categories.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('en_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="en_name" id="en_name" value="{{ old('en_name', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('spa_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="spa_name" id="spa_name" value="{{ old('spa_name', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('fr_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="fr_name" id="fr_name" value="{{ old('fr_name', '') }}" required>
                        ...
                        <div class="form-group {{ $errors->has('nl_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nl_name" id="nl_name" value="{{ old('nl_name', '') }}" required>
