    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.partner-categories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('spa_name') ? 'is-invalid' : '' }}" type="text" name="spa_name" id="spa_name" value="{{ old('spa_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fr_name') ? 'is-invalid' : '' }}" type="text" name="fr_name" id="fr_name" value="{{ old('fr_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nl_name') ? 'is-invalid' : '' }}" type="text" name="nl_name" id="nl_name" value="{{ old('nl_name', '') }}" required>
