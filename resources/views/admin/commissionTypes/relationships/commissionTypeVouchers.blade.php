            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="table-responsive">
                        <table class=" table table-bordered table-striped table-hover datatable datatable-commissionTypeVouchers">
                            <thead>
                                <tr>
                                    <th width="10">
                                    ...
                                    <th>
                                        {{ trans('cruds.voucher.fields.status') }}
                                    </th>
                                    <th>
                                        &nbsp;
                                    </th>
                            ...
                            <tbody>
                                @foreach($vouchers as $key => $voucher)
                                    <tr data-entry-id="{{ $voucher->id }}">
                                        ...
                                        <td>
                                            {{ App\Models\Voucher::STATUS_SELECT[$voucher->status] ?? '' }}
                                        </td>
                                        <td>
                                            @can('voucher_show')
...
@endcan
  ...
  let table = $('.datatable-commissionTypeVouchers:not(.ajaxTable)').DataTable({ buttons: dtButtons })
