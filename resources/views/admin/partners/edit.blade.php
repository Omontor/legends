                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.partners.update", [$partner->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('phone') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone" id="phone" value="{{ old('phone', $partner->phone) }}">
                            @if($errors->has('phone'))
                        ...
                        <div class="form-group {{ $errors->has('en_description') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="en_description" id="en_description" value="{{ old('en_description', $partner->en_description) }}">
                        ...
                        <div class="form-group {{ $errors->has('es_description') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="es_description" id="es_description" value="{{ old('es_description', $partner->es_description) }}">
                        ...
                        <div class="form-group {{ $errors->has('fr_description') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="fr_description" id="fr_description" value="{{ old('fr_description', $partner->fr_description) }}">
                        ...
                        <div class="form-group {{ $errors->has('nl_description') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nl_description" id="nl_description" value="{{ old('nl_description', $partner->nl_description) }}">
