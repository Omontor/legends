                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.vouchers.update", [$voucher->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('guid') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="guid" id="guid" value="{{ old('guid', $voucher->guid) }}" required>
                            @if($errors->has('guid'))
                        ...
                        <div class="form-group {{ $errors->has('en_description') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="en_description" id="en_description" value="{{ old('en_description', $voucher->en_description) }}">
                        ...
                        <div class="form-group {{ $errors->has('es_description') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="es_description" id="es_description" value="{{ old('es_description', $voucher->es_description) }}">
                        ...
                        <div class="form-group {{ $errors->has('nl_description') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="nl_description" id="nl_description" value="{{ old('nl_description', $voucher->nl_description) }}">
                        ...
                        <div class="form-group {{ $errors->has('fr_description') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="fr_description" id="fr_description" value="{{ old('fr_description', $voucher->fr_description) }}">
                        ...
                        <div class="form-group {{ $errors->has('group_size') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="number" name="group_size" id="group_size" value="{{ old('group_size', $voucher->group_size) }}" step="1">
                        ...
                        <div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="status" id="status">
                                ...
                                @foreach(App\Models\Voucher::STATUS_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('status', $voucher->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
